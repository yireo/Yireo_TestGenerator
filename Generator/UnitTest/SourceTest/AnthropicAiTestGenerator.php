...
class AnthropicAiTestGenerator implements AiSourceTestGeneratorInterface
{
    public function __construct(
        private Config $config,
        private AnthropicClientWrapper $clientWrapper,
    ) {
    }
    ...
    public function generate(ClassStub $classStub, ClassStub $testClassStub): string|PhpGenerator
    {
        ...
        $contents = $this->clientWrapper->chat($prompt, $anthropicAiApiKey);
